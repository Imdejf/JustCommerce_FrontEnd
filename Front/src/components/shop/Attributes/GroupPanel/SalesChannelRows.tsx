  ...
  return (
    <>
      {rows.map(({ value, salesChannel, id, isValuePercentage }, rowIndex) => {
        const currentField =
          values.conditionsGroups[groupIndex].conditionsSubgroups[subGroupIndex]
            .conditionsRows[rowIndex];
        ...
        return (
          <tr key={rowIndex + id}>
            ...
            <td className="border border-gray border-opacity-30 border-l-0 border-r-0 ">
              {" "}
              {salesChannel.name}
            </td>
            {/* <td className="border border-gray border-opacity-30 border-l-0 "></td> */}
