...
interface IBlogItemTopBarProps {
  blogItem: IBlogItemInterface
} 

const BlogItemDetailTopBarTopBar: React.FC<IBlogItemTopBarProps> = ({
    blogItem,
}) => {
...
export default BlogItemDetailTopBarTopBar;