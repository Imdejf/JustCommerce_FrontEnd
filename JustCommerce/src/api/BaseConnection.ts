...
const remoteEndpoints = {
  ...
  blog: "/api/administration/BlogCategory",
  blogItem: "/api/administration/BlogItem",
  //old
  artists: {
...
const connections = {
  ...
  test: {
    ...
    blog: ":5000/api/administration/BlogCategory",
    blogItem: ":5000/api/administration/BlogItem",
    artists: {
