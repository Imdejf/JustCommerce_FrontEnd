...
interface IProductAttributeGroupTopBarProps {
...
const ProductAttributeGroupTopBar: React.FC<IProductAttributeGroupTopBarProps> = ({
    handleQueryChange,
    sortBy,
    setSortBy,
    sorts,
    ...
    const handleAddUser = () => {
        push("/catalog/product-attribute-group/add");
    };
...
export default ProductAttributeGroupTopBar;
