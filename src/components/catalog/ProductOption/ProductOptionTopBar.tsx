...
interface IProductOptionBarProps {
...
const ProductOptionTopBar: React.FC <IProductOptionBarProps> = ({
    handleQueryChange,
    sortBy,
    setSortBy,
    sorts,
    ...
    const handleAddUser = () => {
        push("/catalog/product-option/add");
    };
...
export default ProductOptionTopBar;